...
: ${NUODB_CP_IMAGE:="ghcr.io/nuodb/nuodb-cp-images:2.4.1"}
...
# Start DBaaS Operator. Disable webhooks and backups, which cannot work in this environment.
...
# Wait for REST service to become ready
check() {
